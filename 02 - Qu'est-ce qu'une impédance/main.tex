...
\begin{tikzpicture}[remember picture, overlay]
        \node[at=(current page.center)] {
            {\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{pictures/background/background-PCB.png}}
        };
    \end{tikzpicture}
}
...
\begin{frame}{Table des matières}
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            \begin{figure}
                \includegraphics[width=\textwidth]{pictures/qqoqcp.png}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
