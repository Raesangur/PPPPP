...
\begin{frame}{Recherche de régulateur sur Digikey}
    \only<+>{
        \makefigure[1][0.9]{digikey/search}
    }
    \only<+>{
        \makefigure[1][0.8]{digikey/main-page}
    }
    \only<+>{
        \makefigure[1][0.9]{digikey/first-filters}
    }
    \only<+>{
        \makefigure[1][0.9]{digikey/power-filters}
    }
    \only<+>{
        \makefigure[1][0.9]{digikey/mfr-filters}
    }
    \only<+>{
        \makefigure[1][0.8]{digikey/ordering}
    }
    \only<+>{
        \begin{twocolumns}
            \leftcol
