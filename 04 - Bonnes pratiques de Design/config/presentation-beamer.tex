    ...
    \AtBeginSection[]{%
        ...
        \begin{frame}[plain]%
             ...
             \begin{tikzpicture}
                ...
                \path (mainbox) node[rectangle, minimum width=\boxwidth, rounded corners=\cornerradius, minimum height=\boxheight, save path=\inbox] at (0, 0) {};
                \tikzset{protect=\inbox}

                \fill[black, opacity=0.3, rounded corners=\cornerradius] 
