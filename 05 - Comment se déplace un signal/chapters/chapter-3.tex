...
\begin{frame}{Qu'est-ce qu'un impédance?}
    \begin{twocolumns}
        \leftcol
        \begin{itemize}
...
\begin{frame}{Constante de propagation}
    \begin{twocolumns}
        ...
        \begin{adjustbox}{width=\textwidth, height=0.8\textheight, keepaspectratio}
            \begin{tikzpicture}
                \begin{axis}[
                  title={Amplitude of an electromagnetic wave versus distance},
                  xmin=0, xmax=40,
                  ymin=-200, ymax=200,
                  xlabel={Distance from source (``L'')},
                  ylabel={Amplitude (percent of original)},
                  xtick={0,5,...,40},
                ...
                \addlegendentry{Cos($\beta$\,L)}

                \addplot[red] {100*exp(-0.0536*x)};
                \addlegendentry{Exp($-\alpha$\,L)}

                \addplot[accent] {100*exp(-0.0536*x)*cos(60*x)};
                \addlegendentry{Composite waveform}
            ...
            \begin{center}
                ...
                \begin{adjustbox}{width=\textwidth, height=0.7\textheight, keepaspectratio}%
                    \begin{tikzpicture}
                        ...
                        \only<1>{
                            \fill[gray, dashed, fill opacity = 0.2, rounded corners] (-1.5, 1.5) rectangle (3.5, -4.5);
...
\begin{frame}{Tous les GND ne sont pas égaux!}
    ...
    \begin{twocolumns}
        \leftcol
        \makefigure[1][0.33]{level-3/oscilloscope-normal}

        \rightcol
        \makefigure[1][0.33][\cite{hamdand-2011}]{level-3/oscilloscope-improved}
    \end{twocolumns}
\end{frame}
