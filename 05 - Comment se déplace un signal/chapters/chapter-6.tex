...
\begin{frame}{Radiation}
    \vspace{-20pt}
    \makefigure[1.0][1.0][]{level-6/radiation-1}
\end{frame}

\begin{frame}{Radiation}
    \vspace{-20pt}
    \makefigure[1.0][1.0][]{level-6/radiation-2}
\end{frame}

\begin{frame}{Radiation}
    \vspace{-20pt}
    \makefigure[1.0][1.0][]{level-6/radiation-3}
\end{frame}

\begin{frame}{Monopole Antenna}
    \begin{twocolumns}[0.3]
        \leftcol
            \makefigure[1.0][0.7][]{level-6/monopole-1}
        \rightcol
            \makefigure[1.0][0.7][]{level-6/monopole-2}
    \end{twocolumns}
\end{frame}
